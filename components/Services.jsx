...
const Services = () => {
  return (
    ...
    className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>As a motivated and enthusiastic fresher in Full Stack Development with a focus on the MERN stack, my objective is to contribute to the development of dynamic and innovative web applications.</motion.p>
