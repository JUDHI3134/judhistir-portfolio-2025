...
const Project = ({isdarkMode}) => {
  return (
    ...
    className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my Web Developement Portfolio! Explore a collection of projects showcasing my experties in full stack developement.</motion.p>
