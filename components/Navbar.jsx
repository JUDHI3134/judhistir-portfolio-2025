...
const Navbar = ({isdarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
      ...
      <nav className={`w-full fixed px-5 flex items-center justify-between lg:px-8 xl:px-[8%] py-4 z-50 ${isScroll ? "bg-white bg-opacity-70 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
        ...
        <div className='flex items-center gap-4'>
            ...
            <Image src={isdarkMode ? assets.arrow_icon_dark :assets.arrow_icon} className='w-3' alt='arrow' /> </a>
        ...
        <ul ref={sideMenuRef} className='flex flex-col md:hidden gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
        ...
        <li><a className='font-Ovo' href="#top">Home</a></li>
            ...
            <li><a onClick={closeMenu} className='font-Ovo' href="#experience">Services</a></li>
